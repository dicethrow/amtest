...
from amtest.boards.ulx3s.gui_ui.common.test_common import fpga_gui_interface, fpga_mcu_interface
...
if __name__ == "__main__":
	...
	if args.action == "generate":
		...
		from amtest.boards.ulx3s.gui_ui.fpga_gateware import fpga_io_sim
